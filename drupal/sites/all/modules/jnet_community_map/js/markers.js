    ...
    (function($) {
      jQuery.fn.gogMap = function(markers_raw, custom_style) {
        ...
        if(google.loader.ClientLocation) {
          userLoc =  new google.maps.LatLng(google.loader.ClientLocation.latitude, google.loader.ClientLocation.longitude);
        }
        ...
        for (var m_id in markers_raw) {
          ...
          var marker = new google.maps.Marker({
            ...
            map: map,
            title: "Group Name",
            icon: "http://flyerzoo.com/TheJourney/circle-icon.png",
            leaderEmail: "",
            churchIndex: 0,
            dayIndex: [],
            typeIndex: 0,
          ...
          var markerWindow =
          "<h1>" + marker.title + "</h1>" +
          "<h2>Home Church: " + markers_raw[m_id].campus.replace(/^\s+|\s+$/g,'') + "</h2>" +
          "<h2>Type: " + typeGroups[marker.typeIndex] + " " + kidFriendlyString + "</h2>" +
          "<div class='dayBox'><span class='" + dayChecker(1) +  "'>M</span><span class='" + dayChecker(2) +  "'>T</span><span class='" + dayChecker(3) +  "'>W</span><span class='" + dayChecker(4) +  "'></span><span class='" + dayChecker(5) +  "'>R</span><span class='" + dayChecker(6) +  "'>F</span><span class='" + dayChecker(7) +  "'>S</span><span class='" + dayChecker(8) +  "'>S</span></div>"+
          "<a href='#' onclick='joinGroup(\""+
                ...
                "\")' class='joinGroup'>Request to Join</a>"+
          "<a href='#' onclick='reportError(\""+
                marker.leaderEmail + "\",\"" + marker.id + "\",\"" + marker.title + "\",\"" + returnType(marker.typeIndex) +
                "\",\"" + marker.kidFriendly + "\",\""+ daysString +
                "\")' class='reportError'>Report Incorrect Info</a>";
